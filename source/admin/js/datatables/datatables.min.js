...
oPaginate:{sFirst:"Начало",sLast:"Конец",sNext:"Далее",sPrevious:"Назад"},sEmptyTable:"Нет данных в таблице",sInfo:"Показано _START_ - _END_ из _TOTAL_ товаров",sInfoEmpty:"Нет товаров",sInfoFiltered:"(Поиск из _MAX_ товаров)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Показать _MENU_ товаров",sLoadingRecords:"Загрузка...",sProcessing:"Выполнение...",sSearch:"Поиск:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Нет совпадение с поиском"},oSearch:h.extend({},
